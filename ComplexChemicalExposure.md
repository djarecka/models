...
URI: [bican:ComplexChemicalExposure](https://identifiers.org/brain-bican/vocab/ComplexChemicalExposure)
 ...
 classDiagram
    class ComplexChemicalExposure
      ...
      ComplexChemicalExposure : has_attribute_type
          ...
          ComplexChemicalExposure --|> ontology class : has_attribute_type
        
      ComplexChemicalExposure : has_qualitative_value
        
          ComplexChemicalExposure --|> named thing : has_qualitative_value
        
      ComplexChemicalExposure : has_quantitative_value
        
          ComplexChemicalExposure --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:ComplexChemicalExposure |
| native | bican:ComplexChemicalExposure |
