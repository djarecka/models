...
URI: [bican:OrganismAttribute](https://identifiers.org/brain-bican/vocab/OrganismAttribute)
 ...
 classDiagram
    class OrganismAttribute
      ...
      OrganismAttribute : has_attribute_type
          ...
          OrganismAttribute --|> ontology class : has_attribute_type
        
      OrganismAttribute : has_qualitative_value
        
          OrganismAttribute --|> named thing : has_qualitative_value
        
      OrganismAttribute : has_quantitative_value
        
          OrganismAttribute --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:OrganismAttribute |
| native | bican:OrganismAttribute |
| exact | STY:T032 |
