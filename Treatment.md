...
URI: [bican:Treatment](https://identifiers.org/brain-bican/vocab/Treatment)
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * **Treatment** [ [ExposureEvent](ExposureEvent.md) [ChemicalOrDrugOrTreatment](ChemicalOrDrugOrTreatment.md)]
...
| ---  | --- | --- | --- |
| [has_drug](has_drug.md) | 0..* <br/> [Drug](Drug.md) | connects an entity to one or more drugs | direct |
| [has_device](has_device.md) | 0..* <br/> [Device](Device.md) | connects an entity to one or more (medical) devices | direct |
| [has_procedure](has_procedure.md) | 0..* <br/> [Procedure](Procedure.md) | connects an entity to one or more (medical) procedures | direct |
...
| ---  | ---  |
| self | bican:Treatment |
| native | bican:Treatment |
