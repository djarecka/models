...
URI: [bican:DatasetDistribution](https://identifiers.org/brain-bican/vocab/DatasetDistribution)
...
| ---  | --- | --- | --- |
| [distribution_download_url](distribution_download_url.md) | 0..1 <br/> [String](String.md) |  | direct |
...
| ---  | ---  |
| self | bican:DatasetDistribution |
| native | bican:DatasetDistribution |
