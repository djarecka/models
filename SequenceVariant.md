...
URI: [bican:SequenceVariant](https://identifiers.org/brain-bican/vocab/SequenceVariant)
 ...
 classDiagram
    class SequenceVariant
      ...
      SequenceVariant : in_taxon
          ...
          SequenceVariant --|> organism taxon : in_taxon
...
| ---  | --- | --- | --- |
| [has_gene](has_gene.md) | 0..* <br/> [Gene](Gene.md) | Each allele can be associated with any number of genes | direct |
...
| ---  | ---  |
| self | bican:SequenceVariant |
| native | bican:SequenceVariant |
