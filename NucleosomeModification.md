...
_A chemical modification of a histone protein within a nucleosome octomer or a substitution of a histone with a variant histone isoform. e.g. Histone 4 Lysine 20 methylation (H4K20me), histone variant H2AZ substituting H2A._





URI: [bican:NucleosomeModification](https://identifiers.org/brain-bican/vocab/NucleosomeModification)
 ...
 classDiagram
    class NucleosomeModification
      ...
      NucleosomeModification : in_taxon
          ...
          NucleosomeModification --|> organism taxon : in_taxon
...
| ---  | --- | --- | --- |
| [has_biological_sequence](has_biological_sequence.md) | 0..1 <br/> [BiologicalSequence](BiologicalSequence.md) | connects a genomic feature to its sequence | [GenomicEntity](GenomicEntity.md), [EpigenomicEntity](EpigenomicEntity.md) |
...
| ---  | ---  |
| self | bican:NucleosomeModification |
| native | bican:NucleosomeModification |
