...
URI: [bican:DatasetSummary](https://identifiers.org/brain-bican/vocab/DatasetSummary)
...
| ---  | --- | --- | --- |
| [source_web_page](source_web_page.md) | 0..1 <br/> [String](String.md) |  | direct |
| [source_logo](source_logo.md) | 0..1 <br/> [String](String.md) |  | direct |
...
| ---  | ---  |
| self | bican:DatasetSummary |
| native | bican:DatasetSummary |
