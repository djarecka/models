...
URI: [bican:id](https://identifiers.org/brain-bican/vocab/id)
...
| --- | --- | --- |
[OntologyClass](OntologyClass.md) | a concept or class in an ontology, vocabulary or thesaurus |  no  |
...
[RelationshipType](RelationshipType.md) | An OWL property used as an edge label |  no  |
[TaxonomicRank](TaxonomicRank.md) | A descriptor for the rank within a taxonomic classification |  no  |
...
[SmallMolecule](SmallMolecule.md) | A small molecule entity is a molecular entity characterized by availability i... |  yes  |
