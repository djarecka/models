...
URI: [bican:GenotypicSex](https://identifiers.org/brain-bican/vocab/GenotypicSex)
 ...
 classDiagram
    class GenotypicSex
      ...
      GenotypicSex : has_attribute_type
          ...
          GenotypicSex --|> ontology class : has_attribute_type
        
      GenotypicSex : has_qualitative_value
        
          GenotypicSex --|> named thing : has_qualitative_value
        
      GenotypicSex : has_quantitative_value
        
          GenotypicSex --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:GenotypicSex |
| native | bican:GenotypicSex |
| exact | PATO:0020000 |
