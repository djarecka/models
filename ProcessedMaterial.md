...
URI: [bican:ProcessedMaterial](https://identifiers.org/brain-bican/vocab/ProcessedMaterial)
 ...
 classDiagram
    class ProcessedMaterial
      ...
      ProcessedMaterial : has_chemical_role
          ...
          ProcessedMaterial --|> chemical role : has_chemical_role
      ...
      ProcessedMaterial : is_supplement
          ...
          ProcessedMaterial --|> chemical mixture : is_supplement
      ...
      ProcessedMaterial : trade_name
          ...
          ProcessedMaterial --|> chemical entity : trade_name
...
| ---  | ---  |
| self | bican:ProcessedMaterial |
| native | bican:ProcessedMaterial |
| exact | OBI:0000047 |
