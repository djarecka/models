...
URI: [bican:ExposureEventToPhenotypicFeatureAssociation](https://identifiers.org/brain-bican/vocab/ExposureEventToPhenotypicFeatureAssociation)
...
| [subject](subject.md) | 1..1 <br/> [ExposureEvent](ExposureEvent.md) | connects an association to the subject of the association | [Association](Association.md) |
...
| ---  | ---  |
| self | bican:ExposureEventToPhenotypicFeatureAssociation |
| native | bican:ExposureEventToPhenotypicFeatureAssociation |
