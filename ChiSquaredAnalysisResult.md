...
URI: [bican:ChiSquaredAnalysisResult](https://identifiers.org/brain-bican/vocab/ChiSquaredAnalysisResult)
...
| ---  | ---  |
| self | bican:ChiSquaredAnalysisResult |
| native | bican:ChiSquaredAnalysisResult |
