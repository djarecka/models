...
URI: [bican:object_label_closure](https://identifiers.org/brain-bican/vocab/object_label_closure)
...
annotations:
  denormalized:
    tag: denormalized
    value: 'True'
description: Used to hold the object label closure of an association. This is a denormalized  field
