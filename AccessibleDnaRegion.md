...
URI: [bican:AccessibleDnaRegion](https://identifiers.org/brain-bican/vocab/AccessibleDnaRegion)
 ...
 classDiagram
    class AccessibleDnaRegion
      ...
      AccessibleDnaRegion : in_taxon
          ...
          AccessibleDnaRegion --|> organism taxon : in_taxon
...
| ---  | ---  |
| self | bican:AccessibleDnaRegion |
| native | bican:AccessibleDnaRegion |
| exact | SO:0002231 |
