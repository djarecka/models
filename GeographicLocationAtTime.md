...
URI: [bican:GeographicLocationAtTime](https://identifiers.org/brain-bican/vocab/GeographicLocationAtTime)
...
| ---  | ---  |
| self | bican:GeographicLocationAtTime |
| native | bican:GeographicLocationAtTime |
