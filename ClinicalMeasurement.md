...
URI: [bican:ClinicalMeasurement](https://identifiers.org/brain-bican/vocab/ClinicalMeasurement)
 ...
 classDiagram
    class ClinicalMeasurement
      ...
      ClinicalMeasurement : has_attribute_type
          ...
          ClinicalMeasurement --|> ontology class : has_attribute_type
        
      ClinicalMeasurement : has_qualitative_value
        
          ClinicalMeasurement --|> named thing : has_qualitative_value
        
      ClinicalMeasurement : has_quantitative_value
        
          ClinicalMeasurement --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:ClinicalMeasurement |
| native | bican:ClinicalMeasurement |
| exact | EFO:0001444 |
