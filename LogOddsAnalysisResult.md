...
URI: [bican:LogOddsAnalysisResult](https://identifiers.org/brain-bican/vocab/LogOddsAnalysisResult)
...
| ---  | ---  |
| self | bican:LogOddsAnalysisResult |
| native | bican:LogOddsAnalysisResult |
