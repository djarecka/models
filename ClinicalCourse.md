...
URI: [bican:ClinicalCourse](https://identifiers.org/brain-bican/vocab/ClinicalCourse)
 ...
 classDiagram
    class ClinicalCourse
      ...
      ClinicalCourse : has_attribute_type
          ...
          ClinicalCourse --|> ontology class : has_attribute_type
        
      ClinicalCourse : has_qualitative_value
        
          ClinicalCourse --|> named thing : has_qualitative_value
        
      ClinicalCourse : has_quantitative_value
        
          ClinicalCourse --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:ClinicalCourse |
| native | bican:ClinicalCourse |
| exact | HP:0031797 |
