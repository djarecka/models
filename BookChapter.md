...
URI: [bican:BookChapter](https://identifiers.org/brain-bican/vocab/BookChapter)
...
| ---  | --- | --- | --- |
| [published_in](published_in.md) | 1..1 <br/> [Uriorcurie](Uriorcurie.md) | The enclosing parent book containing the chapter should have industry-standar... | direct |
...
| ---  | ---  |
| self | bican:BookChapter |
| native | bican:BookChapter |
