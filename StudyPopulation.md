...
URI: [bican:StudyPopulation](https://identifiers.org/brain-bican/vocab/StudyPopulation)
 ...
 classDiagram
    class StudyPopulation
      ...
      StudyPopulation : in_taxon
          ...
          StudyPopulation --|> organism taxon : in_taxon
...
| ---  | ---  |
| self | bican:StudyPopulation |
| native | bican:StudyPopulation |
