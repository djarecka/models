...
URI: [bican:CellLineAsAModelOfDiseaseAssociation](https://identifiers.org/brain-bican/vocab/CellLineAsAModelOfDiseaseAssociation)
 ...
 classDiagram
    class CellLineAsAModelOfDiseaseAssociation
      ...
      CellLineAsAModelOfDiseaseAssociation : has_evidence
          ...
          CellLineAsAModelOfDiseaseAssociation --|> evidence type : has_evidence
      ...
      CellLineAsAModelOfDiseaseAssociation : object_category
          ...
          CellLineAsAModelOfDiseaseAssociation --|> ontology class : object_category
        
      CellLineAsAModelOfDiseaseAssociation : object_category_closure
        
          CellLineAsAModelOfDiseaseAssociation --|> ontology class : object_category_closure
      ...
      CellLineAsAModelOfDiseaseAssociation : onset_qualifier
        
          CellLineAsAModelOfDiseaseAssociation --|> onset : onset_qualifier
      ...
      CellLineAsAModelOfDiseaseAssociation : qualifiers
          ...
          CellLineAsAModelOfDiseaseAssociation --|> ontology class : qualifiers
        
      CellLineAsAModelOfDiseaseAssociation : retrieval_source_ids
        
          CellLineAsAModelOfDiseaseAssociation --|> retrieval source : retrieval_source_ids
        
      CellLineAsAModelOfDiseaseAssociation : severity_qualifier
        
          CellLineAsAModelOfDiseaseAssociation --|> severity value : severity_qualifier
        
      CellLineAsAModelOfDiseaseAssociation : subject
        
          CellLineAsAModelOfDiseaseAssociation --|> cell line : subject
        
      CellLineAsAModelOfDiseaseAssociation : subject_category
        
          CellLineAsAModelOfDiseaseAssociation --|> ontology class : subject_category
        
      CellLineAsAModelOfDiseaseAssociation : subject_category_closure
        
          CellLineAsAModelOfDiseaseAssociation --|> ontology class : subject_category_closure
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1..1 <br/> [CellLine](CellLine.md) | A cell line derived from an organismal entity with a disease state that is us... | [Association](Association.md) |
...
| ---  | ---  |
| self | bican:CellLineAsAModelOfDiseaseAssociation |
| native | bican:CellLineAsAModelOfDiseaseAssociation |
