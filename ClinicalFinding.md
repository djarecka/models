...
URI: [bican:ClinicalFinding](https://identifiers.org/brain-bican/vocab/ClinicalFinding)
 ...
 classDiagram
    class ClinicalFinding
      ...
      ClinicalFinding : has_attribute
          ...
          ClinicalFinding --|> clinical attribute : has_attribute
        
      ClinicalFinding : id
        
      ClinicalFinding : in_taxon
        
          ClinicalFinding --|> organism taxon : in_taxon
...
| [has_attribute](has_attribute.md) | 0..* <br/> [ClinicalAttribute](ClinicalAttribute.md) | connects any entity to an attribute | [Entity](Entity.md) |
...
| ---  | ---  |
| self | bican:ClinicalFinding |
| native | bican:ClinicalFinding |
