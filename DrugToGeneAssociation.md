...
URI: [bican:DrugToGeneAssociation](https://identifiers.org/brain-bican/vocab/DrugToGeneAssociation)
 ...
 classDiagram
    class DrugToGeneAssociation
      ...
      DrugToGeneAssociation : has_evidence
          ...
          DrugToGeneAssociation --|> evidence type : has_evidence
      ...
      DrugToGeneAssociation : object
          ...
          DrugToGeneAssociation --|> gene or gene product : object
        
      DrugToGeneAssociation : object_category
        
          DrugToGeneAssociation --|> ontology class : object_category
        
      DrugToGeneAssociation : object_category_closure
        
          DrugToGeneAssociation --|> ontology class : object_category_closure
      ...
      DrugToGeneAssociation : qualifiers
          ...
          DrugToGeneAssociation --|> ontology class : qualifiers
        
      DrugToGeneAssociation : retrieval_source_ids
        
          DrugToGeneAssociation --|> retrieval source : retrieval_source_ids
      ...
      DrugToGeneAssociation : subject_category
          ...
          DrugToGeneAssociation --|> ontology class : subject_category
        
      DrugToGeneAssociation : subject_category_closure
        
          DrugToGeneAssociation --|> ontology class : subject_category_closure
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1..1 <br/> [Drug](Drug.md) | the drug that is an interactor | [Association](Association.md) |
...
| [object](object.md) | 1..1 <br/> [GeneOrGeneProduct](GeneOrGeneProduct.md) | the gene or gene product that is affected by the drug | [Association](Association.md) |
...
| ---  | ---  |
| self | bican:DrugToGeneAssociation |
| native | bican:DrugToGeneAssociation |
| related | SIO:001257 |
