...
URI: [bican:Behavior](https://identifiers.org/brain-bican/vocab/Behavior)
 ...
 classDiagram
    class Behavior
      ...
      Behavior : enabled_by
          ...
          Behavior --|> physical entity : enabled_by
      ...
      Behavior : has_input
          ...
          Behavior --|> named thing : has_input
        
      Behavior : has_output
        
          Behavior --|> named thing : has_output
        
      Behavior : id
        
      Behavior : in_taxon
        
          Behavior --|> organism taxon : in_taxon
