...
URI: [bican:Snv](https://identifiers.org/brain-bican/vocab/Snv)
...
| ---  | --- | --- | --- |
| [has_gene](has_gene.md) | 0..* <br/> [Gene](Gene.md) | Each allele can be associated with any number of genes | [SequenceVariant](SequenceVariant.md) |
