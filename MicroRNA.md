...
URI: [bican:MicroRNA](https://identifiers.org/brain-bican/vocab/MicroRNA)
...
```mermaid
 classDiagram
    class MicroRNA
      ...
      MicroRNA : available_from
        
          MicroRNA --|> DrugAvailabilityEnum : available_from
      ...
      MicroRNA : has_biological_sequence
        
      MicroRNA : has_chemical_role
        
          MicroRNA --|> chemical role : has_chemical_role
        
      MicroRNA : id
        
      MicroRNA : in_taxon
        
          MicroRNA --|> organism taxon : in_taxon
        
      MicroRNA : in_taxon_label
        
      MicroRNA : iri
        
      MicroRNA : is_metabolite
        
      MicroRNA : is_toxic
        
      MicroRNA : max_tolerated_dose
      ...
      MicroRNA : trade_name
          ...
          MicroRNA --|> chemical entity : trade_name
