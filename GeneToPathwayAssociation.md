...
URI: [bican:GeneToPathwayAssociation](https://identifiers.org/brain-bican/vocab/GeneToPathwayAssociation)
 ...
 classDiagram
    class GeneToPathwayAssociation
      ...
      GeneToPathwayAssociation : has_evidence
          ...
          GeneToPathwayAssociation --|> evidence type : has_evidence
      ...
      GeneToPathwayAssociation : object_category
          ...
          GeneToPathwayAssociation --|> ontology class : object_category
        
      GeneToPathwayAssociation : object_category_closure
        
          GeneToPathwayAssociation --|> ontology class : object_category_closure
      ...
      GeneToPathwayAssociation : qualifiers
          ...
          GeneToPathwayAssociation --|> ontology class : qualifiers
        
      GeneToPathwayAssociation : retrieval_source_ids
        
          GeneToPathwayAssociation --|> retrieval source : retrieval_source_ids
        
      GeneToPathwayAssociation : subject
        
          GeneToPathwayAssociation --|> gene or gene product : subject
        
      GeneToPathwayAssociation : subject_category
        
          GeneToPathwayAssociation --|> ontology class : subject_category
        
      GeneToPathwayAssociation : subject_category_closure
        
          GeneToPathwayAssociation --|> ontology class : subject_category_closure
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1..1 <br/> [GeneOrGeneProduct](GeneOrGeneProduct.md) | the gene or gene product entity that participates or influences the pathway | [Association](Association.md) |
...
| [object](object.md) | 1..1 <br/> [Pathway](Pathway.md) | the pathway that includes or is affected by the gene or gene product | [Association](Association.md) |
...
| ---  | ---  |
| self | bican:GeneToPathwayAssociation |
| native | bican:GeneToPathwayAssociation |
