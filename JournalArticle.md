...
URI: [bican:JournalArticle](https://identifiers.org/brain-bican/vocab/JournalArticle)
...
| ---  | --- | --- | --- |
| [published_in](published_in.md) | 1..1 <br/> [Uriorcurie](Uriorcurie.md) | The enclosing parent serial containing the article should have industry-stand... | [Article](Article.md) |
...
| ---  | ---  |
| self | bican:JournalArticle |
| native | bican:JournalArticle |
...
- PMCID
- doi
description: an article, typically presenting results of research, that is published  in
  an issue of a scientific journal.
