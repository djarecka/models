...
URI: [bican:ProteinFamily](https://identifiers.org/brain-bican/vocab/ProteinFamily)
 ...
 classDiagram
    class ProteinFamily
      ...
      ProteinFamily : in_taxon
          ...
          ProteinFamily --|> organism taxon : in_taxon
...
| ---  | ---  |
| self | bican:ProteinFamily |
| native | bican:ProteinFamily |
