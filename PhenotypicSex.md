...
URI: [bican:PhenotypicSex](https://identifiers.org/brain-bican/vocab/PhenotypicSex)
 ...
 classDiagram
    class PhenotypicSex
      ...
      PhenotypicSex : has_attribute_type
          ...
          PhenotypicSex --|> ontology class : has_attribute_type
        
      PhenotypicSex : has_qualitative_value
        
          PhenotypicSex --|> named thing : has_qualitative_value
        
      PhenotypicSex : has_quantitative_value
        
          PhenotypicSex --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:PhenotypicSex |
| native | bican:PhenotypicSex |
| exact | PATO:0001894 |
