...
URI: [bican:PhenotypicQuality](https://identifiers.org/brain-bican/vocab/PhenotypicQuality)
 ...
 classDiagram
    class PhenotypicQuality
      ...
      PhenotypicQuality : has_attribute_type
          ...
          PhenotypicQuality --|> ontology class : has_attribute_type
        
      PhenotypicQuality : has_qualitative_value
        
          PhenotypicQuality --|> named thing : has_qualitative_value
        
      PhenotypicQuality : has_quantitative_value
        
          PhenotypicQuality --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:PhenotypicQuality |
| native | bican:PhenotypicQuality |
| undefined | PATO:0000001 |
