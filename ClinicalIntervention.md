...
URI: [bican:ClinicalIntervention](https://identifiers.org/brain-bican/vocab/ClinicalIntervention)
...
| ---  | ---  |
| self | bican:ClinicalIntervention |
| native | bican:ClinicalIntervention |
