...
URI: [bican:DatasetVersion](https://identifiers.org/brain-bican/vocab/DatasetVersion)
 ...
 classDiagram
    class DatasetVersion
      ...
      DatasetVersion : has_distribution
          ...
          DatasetVersion --|> dataset distribution : has_distribution
...
| ---  | --- | --- | --- |
| [has_dataset](has_dataset.md) | 0..1 <br/> [Dataset](Dataset.md) |  | direct |
| [ingest_date](ingest_date.md) | 0..1 <br/> [String](String.md) |  | direct |
| [has_distribution](has_distribution.md) | 0..1 <br/> [DatasetDistribution](DatasetDistribution.md) |  | direct |
...
| ---  | ---  |
| self | bican:DatasetVersion |
| native | bican:DatasetVersion |
