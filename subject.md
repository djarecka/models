...
[GeneToGeneAssociation](GeneToGeneAssociation.md) | abstract parent class for different kinds of gene-gene or gene product to gen... |  yes  |
...
[ReactionToParticipantAssociation](ReactionToParticipantAssociation.md) |  |  yes  |
...
[ChemicalToPathwayAssociation](ChemicalToPathwayAssociation.md) | An interaction between a chemical entity and a biological process or pathway |  yes  |
...
[GeneToPhenotypicFeatureAssociation](GeneToPhenotypicFeatureAssociation.md) |  |  yes  |
[GeneToDiseaseAssociation](GeneToDiseaseAssociation.md) |  |  yes  |
[CausalGeneToDiseaseAssociation](CausalGeneToDiseaseAssociation.md) |  |  yes  |
[CorrelatedGeneToDiseaseAssociation](CorrelatedGeneToDiseaseAssociation.md) |  |  yes  |
...
[VariantToPhenotypicFeatureAssociation](VariantToPhenotypicFeatureAssociation.md) |  |  yes  |
...
[GeneAsAModelOfDiseaseAssociation](GeneAsAModelOfDiseaseAssociation.md) |  |  yes  |
[VariantAsAModelOfDiseaseAssociation](VariantAsAModelOfDiseaseAssociation.md) |  |  yes  |
[GenotypeAsAModelOfDiseaseAssociation](GenotypeAsAModelOfDiseaseAssociation.md) |  |  yes  |
[CellLineAsAModelOfDiseaseAssociation](CellLineAsAModelOfDiseaseAssociation.md) |  |  yes  |
[OrganismalEntityAsAModelOfDiseaseAssociation](OrganismalEntityAsAModelOfDiseaseAssociation.md) |  |  yes  |
[OrganismToOrganismAssociation](OrganismToOrganismAssociation.md) |  |  yes  |
[TaxonToTaxonAssociation](TaxonToTaxonAssociation.md) |  |  yes  |
...
[GeneToGoTermAssociation](GeneToGoTermAssociation.md) |  |  yes  |
...
[AnatomicalEntityToAnatomicalEntityAssociation](AnatomicalEntityToAnatomicalEntityAssociation.md) |  |  yes  |
