...
URI: [bican:RegulatoryRegion](https://identifiers.org/brain-bican/vocab/RegulatoryRegion)
 ...
 classDiagram
    class RegulatoryRegion
      ...
      RegulatoryRegion : in_taxon
          ...
          RegulatoryRegion --|> organism taxon : in_taxon
...
| ---  | ---  |
| self | bican:RegulatoryRegion |
| native | bican:RegulatoryRegion |
