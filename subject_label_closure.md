...
URI: [bican:subject_label_closure](https://identifiers.org/brain-bican/vocab/subject_label_closure)
...
annotations:
  denormalized:
    tag: denormalized
    value: 'True'
description: Used to hold the subject label closure of an association. This is a denormalized  field
