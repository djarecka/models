...
URI: [bican:ClinicalAttribute](https://identifiers.org/brain-bican/vocab/ClinicalAttribute)
 ...
 classDiagram
    class ClinicalAttribute
      ...
      ClinicalAttribute : has_attribute_type
          ...
          ClinicalAttribute --|> ontology class : has_attribute_type
        
      ClinicalAttribute : has_qualitative_value
        
          ClinicalAttribute --|> named thing : has_qualitative_value
        
      ClinicalAttribute : has_quantitative_value
        
          ClinicalAttribute --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:ClinicalAttribute |
| native | bican:ClinicalAttribute |
| exact | STY:T201 |
