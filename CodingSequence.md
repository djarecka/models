...
URI: [bican:CodingSequence](https://identifiers.org/brain-bican/vocab/CodingSequence)
 ...
 classDiagram
    class CodingSequence
      ...
      CodingSequence : available_from
          ...
          CodingSequence --|> DrugAvailabilityEnum : available_from
      ...
      CodingSequence : has_chemical_role
          ...
          CodingSequence --|> chemical role : has_chemical_role
        
      CodingSequence : id
        
      CodingSequence : in_taxon
        
          CodingSequence --|> organism taxon : in_taxon
      ...
      CodingSequence : trade_name
          ...
          CodingSequence --|> chemical entity : trade_name
...
| ---  | ---  |
| self | bican:CodingSequence |
| native | bican:CodingSequence |
