...
URI: [bican:ClinicalModifier](https://identifiers.org/brain-bican/vocab/ClinicalModifier)
 ...
 classDiagram
    class ClinicalModifier
      ...
      ClinicalModifier : has_attribute_type
          ...
          ClinicalModifier --|> ontology class : has_attribute_type
        
      ClinicalModifier : has_qualitative_value
        
          ClinicalModifier --|> named thing : has_qualitative_value
        
      ClinicalModifier : has_quantitative_value
        
          ClinicalModifier --|> quantity value : has_quantitative_value
...
| ---  | ---  |
| self | bican:ClinicalModifier |
| native | bican:ClinicalModifier |
