...
URI: [bican:ConceptCountAnalysisResult](https://identifiers.org/brain-bican/vocab/ConceptCountAnalysisResult)
...
| ---  | ---  |
| self | bican:ConceptCountAnalysisResult |
| native | bican:ConceptCountAnalysisResult |
