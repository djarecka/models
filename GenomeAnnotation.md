...
_Location and nomenclature of genes and all of the coding regions in a genome assembly  and the classification of genes and transcripts into types._





URI: [bican:GenomeAnnotation](https://identifiers.org/brain-bican/vocab/GenomeAnnotation)
...
```mermaid
 classDiagram
    class GenomeAnnotation
      Genome <|-- GenomeAnnotation
      
      GenomeAnnotation : category
        
      GenomeAnnotation : content_url
        
      GenomeAnnotation : description
        
      GenomeAnnotation : digest
        
          GenomeAnnotation --|> checksum : digest
        
      GenomeAnnotation : full_name
        
      GenomeAnnotation : has_attribute
        
          GenomeAnnotation --|> attribute : has_attribute
        
      GenomeAnnotation : has_biological_sequence
        
      GenomeAnnotation : id
        
      GenomeAnnotation : in_taxon
        
          GenomeAnnotation --|> organism taxon : in_taxon
        
      GenomeAnnotation : in_taxon_label
        
      GenomeAnnotation : iri
        
      GenomeAnnotation : name
        
      GenomeAnnotation : provided_by
        
      GenomeAnnotation : reference_assembly
        
      GenomeAnnotation : type
        
      GenomeAnnotation : version
        
      GenomeAnnotation : xref
...
| ---  | --- | --- | --- |
| [reference_assembly](reference_assembly.md) | 0..1 <br/> [Uriorcurie](Uriorcurie.md) |  | direct |
| [version](version.md) | 0..1 <br/> [String](String.md) |  | direct |
| [digest](digest.md) | 1..* <br/> [Checksum](Checksum.md) |  | direct |
| [content_url](content_url.md) | 0..* <br/> [String](String.md) |  | direct |
...
| ---  | --- | --- | --- |
| [GeneAnnotation](GeneAnnotation.md) | [referenced_in](referenced_in.md) | range | [GenomeAnnotation](GenomeAnnotation.md) |
| [AnnotationCollection](AnnotationCollection.md) | [genome_annotations](genome_annotations.md) | range | [GenomeAnnotation](GenomeAnnotation.md) |
...
| ---  | ---  |
| self | bican:GenomeAnnotation |
| native | bican:GenomeAnnotation |
...
description: Location and nomenclature of genes and all of the coding regions in a
  genome assembly  and the classification of genes and transcripts into types.
...
attributes:
  reference assembly:
    name: reference assembly
    from_schema: https://identifiers.org/brain-bican/kb-model
    rank: 1000
    alias: reference_assembly
    owner: genome annotation
    domain_of:
    - genome annotation
    range: uriorcurie
  version:
