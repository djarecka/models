...
URI: [bican:RelativeFrequencyAnalysisResult](https://identifiers.org/brain-bican/vocab/RelativeFrequencyAnalysisResult)
...
| ---  | ---  |
| self | bican:RelativeFrequencyAnalysisResult |
| native | bican:RelativeFrequencyAnalysisResult |
