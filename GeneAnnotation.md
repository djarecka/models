...
_An annotation describing the location, boundaries, and functions of  individual genes within a genome annotation._





URI: [bican:GeneAnnotation](https://identifiers.org/brain-bican/vocab/GeneAnnotation)
...
```mermaid
 classDiagram
    class GeneAnnotation
      ...
      GeneAnnotation : category
        
      GeneAnnotation : description
        
      GeneAnnotation : full_name
        
      GeneAnnotation : has_attribute
        
          GeneAnnotation --|> attribute : has_attribute
        
      GeneAnnotation : has_biological_sequence
        
      GeneAnnotation : id
        
      GeneAnnotation : in_taxon
        
          GeneAnnotation --|> organism taxon : in_taxon
        
      GeneAnnotation : in_taxon_label
        
      GeneAnnotation : iri
        
      GeneAnnotation : molecular_type
        
          GeneAnnotation --|> BioType : molecular_type
        
      GeneAnnotation : name
        
      GeneAnnotation : provided_by
        
      GeneAnnotation : referenced_in
        
          GeneAnnotation --|> genome annotation : referenced_in
        
      GeneAnnotation : symbol
        
      GeneAnnotation : synonym
...
| ---  | --- | --- | --- |
| [referenced_in](referenced_in.md) | 0..1 <br/> [GenomeAnnotation](GenomeAnnotation.md) |  | direct |
...
| ---  | --- | --- | --- |
| [Mapping](Mapping.md) | [gene_identifier_1](gene_identifier_1.md) | range | [GeneAnnotation](GeneAnnotation.md) |
| [Mapping](Mapping.md) | [gene_identifier_2](gene_identifier_2.md) | range | [GeneAnnotation](GeneAnnotation.md) |
| [AnnotationCollection](AnnotationCollection.md) | [annotations](annotations.md) | range | [GeneAnnotation](GeneAnnotation.md) |
...
| ---  | ---  |
| self | bican:GeneAnnotation |
| native | bican:GeneAnnotation |
...
- MGI
- NCBIGene
description: An annotation describing the location, boundaries, and functions of  individual
  genes within a genome annotation.
