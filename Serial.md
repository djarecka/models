...
URI: [bican:Serial](https://identifiers.org/brain-bican/vocab/Serial)
...
| [id](id.md) | 1..1 <br/> [String](String.md) | Serials (journals) should have industry-standard identifier such as from ISSN | [Entity](Entity.md) |
...
| [type](type.md) | 0..* <br/> [String](String.md) | Should generally be set to an ontology class defined term for 'serial' or 'jo... | [Entity](Entity.md) |
