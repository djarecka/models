...
URI: [bican:NoncodingRNAProduct](https://identifiers.org/brain-bican/vocab/NoncodingRNAProduct)
...
```mermaid
 classDiagram
    class NoncodingRNAProduct
      ...
      NoncodingRNAProduct : available_from
        
          NoncodingRNAProduct --|> DrugAvailabilityEnum : available_from
      ...
      NoncodingRNAProduct : has_biological_sequence
        
      NoncodingRNAProduct : has_chemical_role
        
          NoncodingRNAProduct --|> chemical role : has_chemical_role
        
      NoncodingRNAProduct : id
        
      NoncodingRNAProduct : in_taxon
        
          NoncodingRNAProduct --|> organism taxon : in_taxon
        
      NoncodingRNAProduct : in_taxon_label
        
      NoncodingRNAProduct : iri
        
      NoncodingRNAProduct : is_metabolite
        
      NoncodingRNAProduct : is_toxic
        
      NoncodingRNAProduct : max_tolerated_dose
      ...
      NoncodingRNAProduct : trade_name
        
          NoncodingRNAProduct --|> chemical entity : trade_name
...
| [xref](xref.md) | 0..* <br/> [Uriorcurie](Uriorcurie.md) | A database cross reference or alternative identifier for a NamedThing or edge... | [GeneProductMixin](GeneProductMixin.md), [NamedThing](NamedThing.md) |
...
| ---  | ---  |
| self | bican:NoncodingRNAProduct |
| native | bican:NoncodingRNAProduct |
