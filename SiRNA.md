...
URI: [bican:SiRNA](https://identifiers.org/brain-bican/vocab/SiRNA)
...
```mermaid
 classDiagram
    class SiRNA
      ...
      SiRNA : available_from
        
          SiRNA --|> DrugAvailabilityEnum : available_from
      ...
      SiRNA : has_biological_sequence
        
      SiRNA : has_chemical_role
        
          SiRNA --|> chemical role : has_chemical_role
        
      SiRNA : id
        
      SiRNA : in_taxon
        
          SiRNA --|> organism taxon : in_taxon
      ...
      SiRNA : trade_name
          ...
          SiRNA --|> chemical entity : trade_name
