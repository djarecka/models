...
_A combination of entity and quality that makes up a phenotyping statement. An observable characteristic of an  individual resulting from the interaction of its genotype with its molecular and physical environment._





URI: [bican:PhenotypicFeature](https://identifiers.org/brain-bican/vocab/PhenotypicFeature)
...
| ---  | ---  |
| self | bican:PhenotypicFeature |
| native | bican:PhenotypicFeature |
